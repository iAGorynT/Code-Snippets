...
alias pwdex="Pwdex.sh"			# Password Extractor
...
alias np="clear; echo 'Node Processes...'; echo; echo 'PID    CPU  MEM  COMMAND'; ps -eo pid,pcpu,pmem,comm | grep -w node | column -t" # List Node Processes with Header (Optimized)
alias bp="clear; echo 'Bun Processes...'; echo; echo 'PID    CPU  MEM  COMMAND'; ps -eo pid,pcpu,pmem,comm | grep -w bun | column -t" # List Bun Processes with Header (Optimized)
