        ...
        function generateDates() {
            ...
            if (dates.length === 0) {
                ...
                dates.forEach((date, index) => {
                    ...
                    // Add "days from today" and "weeks from today" if the date is in the future
                    if (daysFromToday > 0) {
                        dateString += ` <span style="color: var(--accent-color);">(${daysFromToday} days from today, ${weeksFromToday} weeks)</span>`;
                    }
