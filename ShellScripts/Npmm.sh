...
function menu {
    ...
    printf "\t2. Outdated Global Npm/Bun Packages\n"
    printf "\t3. Npm/Bun Global Package Updates\n"
    printf "\t4. Uninstall Npm/Bun Global Package\n"
    printf "\n"
    printf "\t\033[4;36mTests\033[0m\n"
    printf "\t5. Uninstall Npm/Bun Global Package (TEST MODE)\n"
    printf "\n"
    printf "\t0. Exit Menu\n\n"
